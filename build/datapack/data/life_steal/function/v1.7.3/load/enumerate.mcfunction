...
#> life_steal:v1.7.3/load/enumerate
#
...
execute if score #life_steal.major load.status matches 1 if score #life_steal.minor load.status matches 7 unless score #life_steal.patch load.status matches 3.. run scoreboard players set #life_steal.patch load.status 3
