...
#> life_steal:v2.3.0/load/confirm_load
#
# @within	life_steal:v2.3.0/load/secondary
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded LifeSteal v2.3.0]","color":"green"}
scoreboard players set #life_steal.loaded load.status 1
function life_steal:v2.3.0/load/set_items_storage
