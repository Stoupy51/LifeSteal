...
#> life_steal:v1.2.6/load/enumerate
#
...
execute if score #life_steal.major load.status matches 1 if score #life_steal.minor load.status matches 2 unless score #life_steal.patch load.status matches 6.. run scoreboard players set #life_steal.patch load.status 6
