...
#> life_steal:v2.1.2/load/confirm_load
#
# @within	life_steal:v2.1.2/load/secondary
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded LifeSteal v2.1.2]","color":"green"}
scoreboard players set #life_steal.loaded load.status 1
function life_steal:v2.1.2/load/set_items_storage
