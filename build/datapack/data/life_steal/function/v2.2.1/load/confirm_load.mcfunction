...
#> life_steal:v2.2.1/load/confirm_load
#
# @within	life_steal:v2.2.1/load/secondary
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded LifeSteal v2.2.1]","color":"green"}
scoreboard players set #life_steal.loaded load.status 1
function life_steal:v2.2.1/load/set_items_storage
