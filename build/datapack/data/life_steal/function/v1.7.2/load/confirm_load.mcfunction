...
#> life_steal:v1.7.2/load/confirm_load
#
# @within	life_steal:v1.7.2/load/valid_dependencies
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded LifeSteal v1.7.2]","color":"green"}
