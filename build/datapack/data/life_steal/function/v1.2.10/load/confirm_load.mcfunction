...
#> life_steal:v1.2.10/load/confirm_load
#
# @within	life_steal:v1.2.10/load/secondary
#
...
# Confirm load
tellraw @a[tag=convention.debug] {"text":"[Loaded LifeSteal v1.2.10]","color":"green"}
scoreboard players set #life_steal.loaded load.status 1

# Items storage
data modify storage life_steal:items all set value {}
data modify storage life_steal:items all.heart set value {"id": "minecraft:command_block","count": 1,"components": {"minecraft:item_model": "life_steal:heart","minecraft:consumable": {},"minecraft:item_name": {"text": "Heart"},"minecraft:lore": [["",{"text": "I","color": "white","italic": false,"font": "life_steal:icons"},{"text": " LifeSteal","italic": true,"color": "blue"}]],"minecraft:custom_data": {"life_steal": {"heart": true},"smithed": {"ignore": {"functionality": true,"crafting": true}}}}}
