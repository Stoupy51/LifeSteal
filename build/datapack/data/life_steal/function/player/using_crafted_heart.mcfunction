...
#
# @within	advancement life_steal:using_crafted_heart
#

# Revoke the advancement
advancement revoke @s only life_steal:using_crafted_heart
...
clear @s *[custom_data~{life_steal:{"crafted_heart":true}}] 1
