...
execute unless data storage life_steal:main player if data entity @s Inventory[-1].components."minecraft:custom_data".life_steal.revive_beacon run data modify storage life_steal:main player set string entity @s Inventory[-1].components."minecraft:custom_name" 1 -1
