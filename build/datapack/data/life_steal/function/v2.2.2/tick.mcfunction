...
#> life_steal:v2.2.2/tick
#
# @within	life_steal:v2.2.2/load/tick_verification
#

# Timers
scoreboard players add #second_5 life_steal.data 1
execute if score #second_5 life_steal.data matches 90.. run function life_steal:v2.2.2/second_5
